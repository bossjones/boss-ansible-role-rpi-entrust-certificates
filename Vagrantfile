...
default = {
  ...
  :ansible_project_name => ENV['_ANSIBLE_PROJECT_NAME'] || 'boss-ansible-role-rpi-entrust-certificates'
}
...
#   config.ssh.forward_agent = true
  ...
  # shared folder setup
  config.vm.synced_folder ".", "/home/vagrant/boss-ansible-role-rpi-entrust-certificates"
